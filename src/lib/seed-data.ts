...
export const BILLS: Bill[] = [
  {
    id: "flamend3",
    number: "Amendment 3",
    title: "Adult Use of Marijuana Amendment",
    chamber: "Florida Constitutional Amendment",
    level: "State",
    description:
      "Would legalize marijuana possession and personal use for adults 21 and older, and let the state's existing licensed medical marijuana operators sell it for non-medical use too.",
    voteDate: "Nov 3, 2026",
    voteStage: "Needs 60% to pass",
    explanation:
      "This amendment would let adults 21 and older legally possess up to 3 ounces of marijuana and use it for any reason, not just with a medical card. It doesn't create a new retail licensing system from scratch — it lets Florida's existing medical marijuana treatment centers, the dispensaries already licensed under the state's medical program, start selling to any adult, not just cardholders. Cities and counties would still be able to ban dispensaries within their own borders, the way some already do for medical dispensaries. It doesn't legalize growing your own plants at home, and it doesn't erase or expunge any existing marijuana convictions — those stay on the record unless a separate law addresses them.",
    yesMeans: [
      "Adults 21+ can legally possess and use marijuana in Florida without a medical card.",
      "Existing licensed medical dispensaries can begin selling to any adult, subject to state regulation.",
      "Individual cities and counties can still vote to ban dispensaries locally.",
    ],
    noMeans: [
      "Marijuana use without a medical card stays illegal in Florida.",
      "The state's medical marijuana program continues operating exactly as it does today, unchanged.",
      "A future amendment or law would need to go through the same process to legalize adult use.",
    ],
    sourceName: "Florida Division of Elections",
    sourceUrl: "https://dos.myflorida.com.example/elections/amendment-3-2026",
    dateAccessed: "Aug 22, 2026",
    dateUpdated: "Aug 15, 2026",
    issues: ["Criminal justice"],
  },
  {
    id: "flamend5",
    number: "Amendment 5",
    title: "Additional Homestead Property Tax Exemption",
    chamber: "Florida Constitutional Amendment",
    level: "State",
    description:
      "Would add a new $25,000 property tax exemption for owner-occupied homes, on top of the exemptions homeowners already get.",
    voteDate: "Nov 3, 2026",
    voteStage: "Needs 60% to pass",
    explanation:
      "Florida homeowners already get a $50,000 homestead exemption on their primary residence. This amendment adds a third $25,000 exemption on top of that, applying to the value of a home between $100,000 and $125,000 — the same structure the last homestead expansion used. It only applies to city, county, and special-district property taxes, not to school district taxes, which are carved out the same way the existing exemptions are. Local governments that rely heavily on homestead property tax revenue would see a larger revenue reduction than ones that don't, since the exemption applies uniformly regardless of a county's budget.",
    yesMeans: [
      "Eligible homeowners get an additional $25,000 knocked off their home's taxable value.",
      "The exemption applies to city, county, and special-district taxes, not school taxes.",
      "Local governments collect less property tax revenue from homesteaded properties going forward.",
    ],
    noMeans: [
      "Homestead exemptions stay at their current levels — no new exemption is added.",
      "Local government property tax revenue is unaffected by this specific change.",
    ],
    sourceName: "Florida Division of Elections",
    sourceUrl: "https://dos.myflorida.com.example/elections/amendment-5-2026",
    dateAccessed: "Aug 22, 2026",
    dateUpdated: "Aug 10, 2026",
    issues: ["Housing"],
  },
  {
    id: "flamend7",
    ...
    level: "State",
    description:
      "Would tie Florida's minimum wage to inflation every year starting in 2027, after the state's existing phased increase to $15/hour finishes.",
    voteDate: "Nov 3, 2026",
    voteStage: "Needs 60% to pass",
    explanation:
      "Florida's minimum wage is already scheduled to reach $15/hour by September 2026 under a prior amendment. This measure picks up after that: starting in 2027, the minimum wage would automatically rise each year by the change in a specific cost-of-living index, the same mechanism several other states already use, rather than staying flat at $15 until voters or the legislature act again. It wouldn't lower the wage in a year prices fall — the amendment sets a floor so it can only hold steady or increase, never decrease.",
    yesMeans: [
      "Starting in 2027, Florida's minimum wage adjusts automatically each year based on inflation.",
      "The wage can hold steady or rise year to year, but the amendment doesn't allow it to drop.",
      "Future increases happen without a new ballot measure or legislative vote.",
    ],
    noMeans: [
      "The minimum wage stays flat at $15/hour after September 2026 until voters or the legislature act again.",
      "Any future increase would require a new law or a new constitutional amendment.",
    ],
    sourceName: "Florida Division of Elections",
    sourceUrl: "https://dos.myflorida.com.example/elections/amendment-7-2026",
  ...
  },
  {
    ...
    title: "Duval County Transit Sales Tax",
    chamber: "Duval County Ballot Measure",
    level: "Local",
    description:
      "Would raise Duval County's sales tax by half a cent for 20 years to pay for bus and transit improvements, including more frequent routes and new rapid-transit corridors.",
    voteDate: "Nov 3, 2026",
    voteStage: "Needs a simple majority to pass",
    explanation:
      "This measure raises the local sales tax rate from 7.5% to 8% for 20 years, with the new revenue legally restricted to funding transit projects — it can't be redirected to the county's general budget. The city's transit authority has published a project list this money would fund (more frequent bus routes, two new rapid-transit corridors, and paratransit service expansion), but that list isn't binding the way the tax itself would be; a future city council could reprioritize which transit projects get funded first without another vote. The tax applies to the same purchases Florida's regular sales tax already applies to, so it doesn't newly tax groceries or rent.",
    yesMeans: [
      "Duval County's sales tax rises from 7.5% to 8% for the next 20 years.",
      "The new revenue is legally restricted to transit projects, not the general county budget.",
      "The transit authority's published project list guides spending, but isn't binding.",
    ],
    noMeans: [
      "The sales tax stays at 7.5%.",
      "The transit authority's expansion plans would need a different funding source to move forward.",
    ],
    sourceName: "Duval County Supervisor of Elections",
    sourceUrl: "https://duvalelections.gov.example/2026/proposition-a",
    dateAccessed: "Aug 23, 2026",
